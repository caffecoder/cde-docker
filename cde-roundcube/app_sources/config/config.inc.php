...
$config['db_dsnw'] = 'mysqli://' . $_ENV['MYSQL_USER'] .':'. $_ENV['MYSQL_PASSWD'] .'@'. $_ENV['MYSQL_HOST'] . '/webmail';
...
$config['default_host'] = 'tls://imap.%d';
...
$config['smtp_helo_host'] = $_ENV['SMTP_HELO'];
...
$config['redis_hosts'] = array( $_ENV['REDIS_HOST'] .':'. $_ENV['REDIS_PORT'] ); // e.g. array( 'localhost:6379' );  array( '192.168.1.1:6379:1:secret' );
...
$config['des_key'] = '4hB79SEzPxHG69jffmTO3ETm';
...
$config['plugins'] = array('archive', 'markasjunk', 'new_user_dialog', 'show_additional_headers', 'vcard_attachments');
...
$config['password_hosts'] = $_SESSION['storage_host'];
...
// NOTE: Use folder names with namespace prefix (INBOX. on Courier-IMAP)
$config['default_folders'] = array('INBOX', 'Drafts', 'Sent', 'Junk', 'Trash', 'Archives');
